...
> Python 3.11 / 3.12 are not supported due to incompatibilities with TensorFlow, DeepChem, DGL, and RDKit.

## Create Virtual Environment inside VSCode Terminal
...
pip install tensorflow==2.15.* keras==2.15.* h5py==3.10.*
